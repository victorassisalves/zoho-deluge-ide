export const staticSuggestions = [
    ...
    { label: 'void function', kind: 3, insertText: 'void ${1:name}($2)\n{\n\t$0\n}', insertTextRules: 4 },
    { label: 'invokeurl', kind: 3, insertText: 'invokeurl\n[\n\turl: "$1"\n\ttype: ${2|GET,POST,PUT,DELETE,PATCH|}\n];', insertTextRules: 4 },
    { label: 'sendmail', kind: 27, insertText: 'sendmail\n[\n\tfrom: zoho.adminuserid\n\tto: "$1"\n\tsubject: "$2"\n\tmessage: "$3"\n];', insertTextRules: 4 },
    { label: 'daysBetween', kind: 3, insertText: 'daysBetween(${1:d1}, ${2:d2})', insertTextRules: 4 }
];
